...
// Wrapped with React.memo to avoid unnecessary re-renders when props don't change
import React, { memo } from 'react';
import { Loader2, Brain, Sparkles } from 'lucide-react';

const OptimizedLoadingScreen = memo(
  ({ message = "Loading your mind map...", progress = null }) => {
    return (
